<div class="row">
	<div class="panel panel-default">
	    <div class="panel-heading">
	        ...
	        Buat Jenis Soal : <a href="?page=quiz&action=buatsoal&hal=soalpilgan&id=<?php echo $id; ?>" class="btn btn-primary btn-sm">Pilihan Ganda</a> <a href="?page=quiz&action=buatsoal&hal=import&id=<?php echo $id; ?>" class="btn btn-primary btn-sm">Import Excel</a></div>
