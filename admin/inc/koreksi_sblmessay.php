    ...
    <div class="row">
    	<div class="panel panel-default">
    	    ...
    	    <div class="panel-body">
                <div class="table-responsive">
                    <table width="100%">
                        <?php
                        $urut = 1;
                        $sql_jawaban = mysql_query("SELECT * FROM tb_jawaban JOIN tb_soal_essay ON tb_jawaban.id_soal =  tb_soal_essay.id_essay WHERE tb_jawaban.id_tq = '$id_tq' AND tb_jawaban.id_siswa = '$_GET[id_siswa]'") or die ($db->error);
                        $jumlah_soal = mysql_num_rows($sql_jawaban);
                        while($data_jawaban = mysql_fetch_array($sql_jawaban)) { ?>
                            <tr>
            ...
            if(@$_POST['simpan_koreksi']) {
                ...
                mysql_query("INSERT INTO tb_nilai_essay VALUES('', '$id_tq', '$_GET[id_siswa]', '$nilai_total')") or die ($db->error);
    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            if(@$_POST['simpan_koreksi']) {
                ...
                $nilai_total = $nilai / $jumlah_soal;
                mysql_query("UPDATE tb_nilai_essay SET nilai = '$nilai_total' WHERE id = '$_GET[id_nilai]'") or die ($db->error);
                echo "<script>window.location='?page=quiz&action=pesertakoreksi&id_tq=".$id_tq."';</script>";
            }
            ?>
        </div>
