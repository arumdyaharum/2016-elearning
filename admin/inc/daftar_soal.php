					...
					<table class="table table-striped table-bordered table-hover">
						...
						if(mysqli_num_rows($sql_essay) > 0) {
							...
							<tr>
								...
								<td><?php echo $data_essay['jawaban']; ?></td>
			...
			?>
				...
				if(@$_POST['simpan']) {
                   ...
                   // $target_audio = 'audio/';
					...
					for($i=0;$i<6;$i++){
						if($nama_gambar[$i] == '') {
							mysqli_query($conn, "UPDATE tb_soal_pilgan SET pertanyaan = '$pertanyaan', pil_a = '$pilA', pil_b = '$pilB', pil_c = '$pilC', pil_d = '$pilD', pil_e = '$pilE', kunci = '$kunci' WHERE id_pilgan = '$idsoal'") or die ($db->error);          
							echo "gambar tidak dihapus dan tidak diperbarui (tetap)";
						} else {
