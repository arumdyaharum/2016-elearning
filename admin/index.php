            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                        ...
                        if($level == 'admin') {
                            $sql_terlogin = mysqli_query($conn, "SELECT * FROM tb_admin WHERE id_admin = '$sesi_id'") or die ($db->error);
                        } else if($level == 'pengajar') {
                            $sql_terlogin = mysqli_query($conn, "SELECT * FROM tb_pengajar WHERE id_pengajar = '$sesi_id'") or die ($db->error);
                        }
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    ?>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
								<li>
                                    <a href="?page=pengajar" class="<?php if(@$_GET['page'] == 'pengajar') { echo 'active-menu'; } ?>"># Manajemen Guru</a>
                                </li>
                                <li>
                    ...
                    ?>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o"></i>Manajemen Soal<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <!--a class="<?php if(@$_GET['page'] == 'indikatorsoal') { echo 'active-menu'; } ?>" href="?page=indikatorsoal"># Buat Indikator Soal</a-->
                                </li>
                                <li>
                                    <a class="<?php if(@$_GET['page'] == 'quiz') { echo 'active-menu'; } ?>" href="?page=quiz"># Paket Soal</a>
                                </li>
                            </ul>
                        </li>
                    <li>
                        <a class="<?php if(@$_GET['page'] == 'berita') { echo 'active-menu'; } ?>" href="?page=berita"># Berita</a>
                    </li>
                </ul>
            </div>
        </nav>
