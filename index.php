...
<?php
$sql_terlogin = mysqli_query($conn, "SELECT * FROM tb_siswa JOIN tb_kelas ON tb_siswa.id_siswa = '$_SESSION[siswa]' AND tb_kelas.id_kelas = tb_siswa.id_kelas") or die ($db->error);
...
?>
    <header>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    Selamat datang <a href="?hal=detailprofil" class="btn btn-xs btn-info"><?php echo $data_terlogin['username']; ?></a> Jangan lupa <a href="inc/logout.php?sesi=siswa" class="btn btn-xs btn-danger">Logout</a>
                </div>
            </div>
        </div>
    </header>
