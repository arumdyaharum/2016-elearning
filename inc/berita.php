        ...
        <div class="notice-board">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul>
                        <?php
                        $sql_berita = mysqli_query($conn, "SELECT * FROM tb_berita WHERE status = 'aktif' ORDER BY tgl_posting DESC LIMIT 0, 4") or die($db->error);
    ...
    ?>
      <div class="col-md-7">
        <div class="notice-board">
          ...
          <div class="panel-body">
          <?php
          $sql_berita_detail = mysqli_query($conn, "SELECT * FROM tb_berita WHERE id_berita = '$_GET[id_berita]'") or die($db->error);
          ...
          ?>
            ...
            By : <span class="label label-warning">
                ...
                if($data_berita_detail['penerbit'] == 'admin') {
                  ...
                  $sql_pengajar = mysqli_query($conn, "SELECT * FROM tb_pengajar WHERE id_pengajar = '$data_berita_detail[penerbit]'") or die($db->error);
