	    ...
	    <div class="col-md-12">
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
					...
					$sql_tq = mysqli_query($conn, "SELECT * FROM tb_topik_quiz WHERE id_mapel = '$id_mapel' AND FIND_IN_SET($data_terlogin[id_kelas], id_kelas) AND status = 'aktif'") or die ($db->error);
					if(mysqli_num_rows($sql_tq) > 0) {
									        ...
									        <tr>
									            ...
									            <td>
									            	...
									            	if($data_tq['pembuat'] != 'admin') {
									            		$sql_peng = mysqli_query($conn, "SELECT * FROM tb_pengajar WHERE id_pengajar = '$data_tq[pembuat]'") or die ($db->error);
						...
						<div class="alert alert-danger">Data quiz yang berada di kelas ini dengan mata pelajaran tersebut tidak ada</div>
						<?php
					} ?>
					</div>
	            </div>
	...
	<div class="row">
	    <div class="col-md-12">
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	            <?php
	            $sql_nilai = mysqli_query($conn, "SELECT * FROM tb_nilai_pilgan WHERE id_tq = '$_GET[id_tq]' AND id_siswa = '$_SESSION[siswa]'") or die ($db->error);
	            ...
	            <div class="panel-footer">
					...
					if(mysqli_num_rows($sql_nilai) > 0) { ?>
						...
						$sql_cek_soal_pilgan = mysqli_query($conn, "SELECT * FROM tb_soal_pilgan WHERE id_tq = '$_GET[id_tq]'") or die ($db->error);
						$sql_cek_soal_essay = mysqli_query($conn, "SELECT * FROM tb_soal_essay WHERE id_tq = '$_GET[id_tq]'") or die ($db->error);
