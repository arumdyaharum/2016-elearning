...
$no = 1;
$no2 = 1;
$sql_tq = mysqli_query($conn, "SELECT * FROM tb_panitia_tq JOIN tb_mapel ON tb_panitia_tq.id_mapel = tb_mapel.id WHERE id_tq = '$id_tq'") or die ($conn->error);
...
var waktunya;
<?php
$waktunya = mysqli_query($conn, "Select * from tb_panitia_kapan where id_tq = $id_tq AND id_siswa = $_SESSION[siswa]");
...
<?php 
                    ...
                    $sql_soal_pilgan = mysqli_query($conn, "SELECT * FROM tb_panitia_soal WHERE id_tq = '$id_tq' order by rand()") or die ($conn->error);
...
<div class="content-wrapper">
    <div class="container">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
					<div class="panel-body">
						...
						$sql_nomornya = mysqli_query($conn, "SELECT * FROM tb_panitia_soal WHERE id_tq = '$id_tq' ") or die ($conn->error);
						
						while($nomornya = mysqli_fetch_array($sql_nomornya)) {
							$warnanya = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM tb_panitia_jawab WHERE id_tq = '$id_tq' && id_siswa = '$_SESSION[siswa]' && id_soal = '$nomornya[id_pilgan]'"));
							if($o<10){
								echo '<a onClick="nomornya('.$nomornya['id_pilgan'].')" id="'.$nomornya['id_pilgan'].'" class="btn ';
								if($warnanya['ragu'] == '1'){
									echo "btn-warning";
									} else if($warnanya['jawaban']){
									echo "btn-success";
									}else{
									echo "btn-danger";}
								echo '">0'.$o++.'</a>';
		    ...
		    <div class="col-md-8">
		    	<form action="inc/proses_soal(GET).php" method="post">
					<?php
					if($sql_soal_row > 0) {
                    ?>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    while($data_soal_pilgan = mysqli_fetch_array($sql_soal_pilgan)) {
										$query_jawab = mysqli_query($conn,"Select * from tb_panitia_jawab where $id_tq = '$id_tq' AND id_siswa = $_SESSION[siswa] AND id_soal = $data_soal_pilgan[id_pilgan]");
										$data_jawab = mysqli_fetch_array($query_jawab);?>
        								<table id="<?php echo $data_soal_pilgan['id_pilgan'];?>" class="table slide<?php if($no == '1'){echo " selected";}?>">
                                            ...
                                            <?php if($data_soal_pilgan['gambarSoal'] != '') { ?>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <img class="gambar_soal" id="s" src="admin/p_img/soal/<?php echo $id_tq.'_'.$data_soal_pilgan['gambarSoal']; ?>" />
                                                    </td>
                                                </tr>
                                            <?php } ?>
        							        <tr>
        							            ...
        							            <td>
                                                    <div class="radio mrg-del">
                                                        <label>
                                                            <input type="radio" name="soal_pilgan[<?php echo $data_soal_pilgan['id_pilgan']; ?>]" value="A" <?php if($data_jawab['jawaban'] == "A"){echo "Checked";}?>/> A. <?php echo $data_soal_pilgan['pil_a']; ?>
                                                        </label>
                                                    </div>
                                                </td>
        							        </tr>
                                            <?php if($data_soal_pilgan['gambarA'] != '') { ?>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <img class="gambar_soal" src="admin/p_img/jawaban/<?php echo $id_tq.'_'.$data_soal_pilgan['gambarA']; ?>" />
                                                    </td>
                                                </tr>
                                            <?php } ?>
        							        <tr>
        							            ...
        							            <td>
                                                    <div class="radio mrg-del">
                                                        <label>
                                                            <input type="radio" name="soal_pilgan[<?php echo $data_soal_pilgan['id_pilgan']; ?>]" value="B" <?php if($data_jawab['jawaban'] == "B"){echo "Checked";}?>/> B. <?php echo $data_soal_pilgan['pil_b']; ?>
                                                        </label>
                                                    </div>
                                                </td>
        							        </tr>
                                            <?php if($data_soal_pilgan['gambarB'] != '') { ?>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <img class="gambar_soal" src="admin/p_img/jawaban/<?php echo $id_tq.'_'.$data_soal_pilgan['gambarB']; ?>" />
                                                    </td>
                                                </tr>
                                            <?php } ?>
        							        <tr>
        							            ...
        							            <td>
                                                    <div class="radio mrg-del">
                                                        <label>
                                                            <input type="radio" name="soal_pilgan[<?php echo $data_soal_pilgan['id_pilgan']; ?>]" value="C" <?php if($data_jawab['jawaban'] == "C"){echo "Checked";}?>/> C. <?php echo $data_soal_pilgan['pil_c']; ?>
                                                        </label>
                                                    </div>
                                                </td>
        							        </tr>
                                            <?php if($data_soal_pilgan['gambarC'] != '') { ?>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <img class="gambar_soal" src="admin/p_img/jawaban/<?php echo $id_tq.'_'.$data_soal_pilgan['gambarC']; ?>" />
                                                    </td>
                                                </tr>
                                            <?php } ?>
        							        <tr>
        							            ...
        							            <td>
                                                    <div class="radio mrg-del">
                                                        <label>
                                                            <input type="radio" name="soal_pilgan[<?php echo $data_soal_pilgan['id_pilgan']; ?>]" value="D" <?php if($data_jawab['jawaban'] == "D"){echo "Checked";}?>/> D. <?php echo $data_soal_pilgan['pil_d']; ?>
                                                        </label>
                                                    </div>
                                                </td>
        							        </tr>
                                            <?php if($data_soal_pilgan['gambarD'] != '') { ?>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <img class="gambar_soal" src="admin/p_img/jawaban/<?php echo $id_tq.'_'.$data_soal_pilgan['gambarD']; ?>" />
                                                    </td>
                                                </tr>
                                            <?php } ?>
        							        <tr>
        							            ...
        							            <td>
                                                    <div class="radio mrg-del">
                                                        <label>
                                                            <input type="radio" name="soal_pilgan[<?php echo $data_soal_pilgan['id_pilgan']; ?>]" value="E" <?php if($data_jawab['jawaban'] == "E"){echo "Checked";}?>/> E. <?php echo $data_soal_pilgan['pil_e']; ?>
                                                        </label>
                                                    </div>
                                                </td>
        							        </tr>
                                            <?php if($data_soal_pilgan['gambarE'] != '') { ?>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <img class="gambar_soal" src="admin/p_img/jawaban/<?php echo $id_tq.'_'.$data_soal_pilgan['gambarE']; ?>" />
                                                    </td>
                                                </tr>
                                            <?php } ?>
										</table>
...
$("input[type=radio],input[type=hidden]").autosave({
	...
	success: function(data) {
		...
		$("a[id=" + data + "]").removeClass("btn-danger");
		$("a[id=" + data + "]").addClass("btn-success");
    },
    dataType: "html"
});		
...
$("#ragu").click(function(){
	$.ajax({
		url : 'inc/ragu.php',
		method : 'post',
		data : 'id_tq='+$("input[name=id_tq]").val()+'&siswa='+$("input[name=siswa]").val()+'&'+$(".selected > input[name=nomorsoal]").serialize(),
		success : function(data){
			var r = data.split(' ');
			$("#message").html("Data updated successfully").show();
			setTimeout('fadeMessage()',1500);
			if(r[1] == '1'){
				if(r[2] == ''){
					$("a[id=" + r[0] + "]").removeClass("btn-danger");
				} else {
					$("a[id=" + r[0] + "]").removeClass("btn-success");
				}
				$("a[id=" + r[0] + "]").addClass("btn-warning");
			} else {
				$("a[id=" + r[0] + "]").removeClass("btn-warning");
				if(r[2] == ''){
					$("a[id=" + r[0] + "]").addClass("btn-danger");
				} else {
					$("a[id=" + r[0] + "]").addClass("btn-success");
				}
			}
		},
		send: function(){
...
function nomornya(x){
	$(".selected").removeClass("selected").fadeOut('fast');
	$("table[id=" + x + "]").addClass('selected').fadeIn('fast');
}
</script>
<?php
} else {
